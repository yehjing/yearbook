<template>
  <div>
    ...
    <h3>音樂藝術的流長軌跡</h3>
    <p>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;國立傳統藝術中心致力於統籌規劃全國傳統藝術之維護、調查、研究、保存、傳承與發展，一方面策辦各式精緻展演以饗各地觀眾，另一方面則進行文物典藏研究及相關出版工作，期盼能為臺灣多樣的傳統文化留下永恆紀錄；配合文化部「重建臺灣藝術史」之政策發展，本中心發起《2018臺灣音樂年鑑》編輯計畫，完整記錄2018年臺灣音樂的活動，並透過觀察與評介，呈現臺灣音樂活躍的生態樣貌。
    </p>
    <p>
